...
function rateLimitedUntil() {
  ...
  // and byte counts. A bare /429/ is not: it matched `12:28:51.5255429Z` on US-004's
  // max-turns failure and reported a five-hour quota outage that was never happening,
