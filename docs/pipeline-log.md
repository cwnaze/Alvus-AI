...
2026-08-07T12:13:15.000Z | US-008 | in_progress | Branch feature/us-008-bootstrap-first-admin-account created; adding a DATABASE_URL-only CLI script to mint the first admin account.
