...
2026-08-30T00:00:00.000Z | US-029 | in_progress | Branch feature/us-029-accessibility-and-responsive-layout-hardening created; starting accessibility/responsive-layout hardening across core flows.
...
2026-08-14T23:29:42.065Z | US-025 | done | PR #55 merged after 1 review round(s)
2026-08-14T23:52:00.000Z | US-026 | in_progress | Branch feature/us-026-rls-integration-test-suite created; building the RLS integration test suite (deny-by-default across roles) -- adding hand-written RLS-enabling migrations/policies for every public table (none existed yet) and a new Node/Vitest integration workspace against the real local Supabase stack proving non-owner/pending/rejected-user denial and a lint step that fails if a new table ships without RLS.
